...
public class RobotMap {
    ...
    public static DoubleSolenoid lifterLifterSolenoid;
    ...
    public static void init() {
        ...
        lifterLifterSolenoid = new DoubleSolenoid(0, 0, 1);      
        LiveWindow.addActuator("Lifter", "Lifter Solenoid", lifterLifterSolenoid);
        
        grabberGrabberSolenoid = new DoubleSolenoid(0, 2, 3);      
        LiveWindow.addActuator("Grabber", "Grabber Solenoid", grabberGrabberSolenoid);
